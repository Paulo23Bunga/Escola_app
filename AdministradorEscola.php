...
<div class="principal">
        ...
        <div id="conteudo"  >
                ...
                <b id="btAdmi" hidden>
                <ul>
                  <li><img class="img1" src="imagem/img/alunos.png" alt=""><button class="bt1" onclick="BtAluno()" id="aluno">Cadastrar Alunos</button></li>
                  <li><img class="img1" src="imagem/img/prof.png" alt=""><button class="bt1" onclick="BtProfessor()" id="professor">Cadastrar Professores</button></li>
                   <li><img class="img1" src="imagem/img/ferramenta.png" alt=""><button class="bt1" onclick="BtFerramenta()" id="ferramenta">Alterações dos Dados</button></li>
                  <li><img class="img1" src="imagem/img/dinheiro.png" alt=""><button class="bt1" onclick="BtFinanca()" id="financa">Pagamento</button></li>
                  <li><img class="img1" src="imagem/img/anucio.png" alt=""><button class="bt1" onclick="BtAnuncio()" id="anuncio">Adicionar Anúncio</button></li>
                ...
                <ul>
                  <li><img class="img1" src="imagem/img/aluno.png" alt=""><button class="bt1" onclick="InfAluno()" id="btInfAluno">Aluno</button></li>
                  <li><img class="img1" src="imagem/img/professor.png" alt=""><button class="bt1" onclick="InfProf()" id="btInfProf">Professor</button></li>
                  <li><img class="img1" src="imagem/img/alunos.png" alt=""><button class="bt1" onclick="InfTurma()" id="btInfTurma">Turmas</button></li>
                  <li><img class="img1" src="imagem/img/dinheiro.png" alt=""><button class="bt1" onclick="InfFinanca()" id="btInfFinanca">Situação Financeira</button></li>
                </ul>
                ...
                <ul>
                  <li><img class="img1" src="imagem/img/alunoMsg.png" alt=""><button class="bt1" >Aluno</button></li>
                  <li><img class="img1" src="imagem/img/profMsg.png" alt=""><button class="bt1" >Professor</button></li>
                  <li><img class="img1" src="imagem/img/turmaMsg.png" alt=""><button class="bt1" >Turmas</button></li>
                  <li><img class="img1" src="imagem/img/ministerioMsg.png" alt=""><button class="bt1" >Ministério</button></li>
                </ul>
...
function Data(){
 ...
 if(segundo<10)
 {
     lbHora.innerHTML = hora+":"+minuto+":0"+segundo;
     if(minuto<10 )
     {
         lbHora.innerHTML = hora+":0"+minuto+":0"+segundo;
         if(hora<10)
         {
              lbHora.innerHTML = "0"+hora+":0"+minuto+":0"+segundo;
         }
     }
 ...
 if(minuto<10)
 {
     lbHora.innerHTML = hora+":0"+minuto+":"+segundo;
     if(segundo<10)
     {
         lbHora.innerHTML = hora+":0"+minuto+":0"+segundo;
         if(hora<10)
 ...
 if(hora<10)
 {
     lbHora.innerHTML ="0"+hora+":"+minuto+":"+segundo;
     if(minuto<10)
     {
         lbHora.innerHTML = "0" +hora+":0"+minuto+":"+segundo;
         if(segundo<10)
         {
              lbHora.innerHTML = "0"+hora+":0"+minuto+":0"+segundo;
         }
